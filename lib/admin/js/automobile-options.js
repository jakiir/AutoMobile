...
function model_edit(THIS) {
    ...
    $('#edit_automobile_model').val(model_value);
    $('#edit_automobile_model').attr("data-keys", data_keys);
    return false;
}
...
function make_edit(THIS) {
    ...
    $('#edit_automobile_make').val(make_value);
    $('#edit_automobile_make').attr("data-keys", data_keys);
    return false;
}
jQuery(document).ready(function($){
    ...
    $( '#automobile_make_submit' ).click( function(e) {
        ...
        $thisbutton.parent().parent().find('.message').html('');
        $thisbutton.parent().parent().find('.reloadIcon').css('display','inline-block');
    ...
    $( '#automobile_make_edit_submit' ).click( function(e) {
        var $thisbutton = $(this);
        var make_val = $('#edit_automobile_make').val();
        var data_keys = $('#edit_automobile_make').attr("data-keys");
        $thisbutton.parent().parent().find('.reloadIcon').css('display','inline-block');
        $.ajax({
            type: 'POST',
            url: adminUrl.ajaxurl,
	...
	$( '#automobile_model_submit' ).click( function(e) {
        var $thisbutton = $(this);
    ...
    $( '#automobile_model_edit_submit' ).click( function(e) {
        var $thisbutton = $(this);
        var model_val = $('#edit_automobile_model').val();
        var data_keys = $('#edit_automobile_model').attr("data-keys");
        $thisbutton.parent().parent().find('.reloadIcon').css('display','inline-block');
        $.ajax({
            type: 'POST',
            url: adminUrl.ajaxurl,
