...
<div class="row">
	...
	<div id="signIn" style="display:none;" class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
        <form role="form">
            ...
            <div class="form-group">
                <input type="password" name="password" id="password" class="form-control input-lg" placeholder="******" tabindex="2">
            </div>    
            ...
            <div class="row">
                ...
                <div class="col-xs-12 col-md-6"><a href="javascript:void(0)" class="btn btn-success btn-block btn-lg">Sign In</a></div>
            </div>
        </form>
    </div>
</div>
