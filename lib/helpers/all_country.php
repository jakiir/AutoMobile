...
if (!class_exists( 'all_country' )){ 
	   ...
	   function create_countryList(){
	       $countryList = array(
					...
					'UY' => __( 'Uruguay', 'automobile' ),
					'UZ' => __( 'Uzbekistan', 'automobile' ),
					'VU' => __( 'Vanuatu', 'automobile' ),
					'VA' => __( 'Vatican', 'automobile' ),
					'VE' => __( 'Venezuela', 'automobile' ),
					'VN' => __( 'Vietnam', 'automobile' ),
					'WF' => __( 'Wallis and Futuna', 'automobile' ),
					'EH' => __( 'Western Sahara', 'automobile' ),
					'WS' => __( 'Western Samoa', 'automobile' ),
					'YE' => __( 'Yemen', 'automobile' ),
					'ZM' => __( 'Zambia', 'automobile' ),
					'ZW' => __( 'Zimbabwe', 'automobile' )
                    );
			return $countryList;
	    }    
